...
export default function Tasks() {
  ...
  useEffect(() => {
    ...
    if (lastGreetingDate !== currentDate && !isLoading) {
      ...
      const message =
        taskCount > 0
          ? `${greeting}! You have ${taskCount} task${
              taskCount > 1 ? "s" : ""
            } today. Let's crush it! 💪`
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8">
          ...
          {showWeeklyView && (
            <div className="mb-6 glass-card rounded-2xl p-4 sm:p-6">
              ...
              <WeeklyGoalView tasks={allTasks} goals={goals} />
            </div>
          )}
          ...
          {tasks.length === 0 && (
            <div className="glass-card p-8 sm:p-12 rounded-2xl text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Add your first task to start crushing your goals!
              </p>
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-xl sm:text-2xl">
                      {goalTasks[0]?.goal?.emoji || "📌"}
                    </span>
                    <h3 className="font-semibold text-base sm:text-lg">
                      {goalName}
                    </h3>
                    <span className="text-xs sm:text-sm text-muted-foreground ml-auto">
                      {goalTasks.filter((t) => t.completed).length}/
                      {goalTasks.length} complete
                    </span>
                    ...
                    {goalTasks.map((task) => {
                      ...
                      return (
                        <TaskItem
                          ...
                          onComplete={() =>
                            handleToggle(task.id, task.completed || false)
                          }
                        ...
                        <div key={task.id} className="flex flex-col gap-2">
                          ...
                          {isRescheduling && (
                            <div className="ml-9 p-3 rounded-lg bg-primary/5 border border-primary/20 flex flex-wrap gap-2">
                              ...
                              <button
                                onClick={() =>
                                  handleRescheduleTask(task.id, today)
                                }
        ...
        <DialogContent className="sm:max-w-[425px] bg-card border-white/10">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              ...
              <Select
                value={newTaskGoalId || "none"}
                onValueChange={(v) => setNewTaskGoalId(v === "none" ? "" : v)}
              >
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setNewTaskPriority(v as "high" | "medium" | "low")
                }
              >
                <SelectTrigger className="bg-secondary border-border">
                  <SelectValue />
      ...
      <ConfettiCelebration
        ...
        type={
          celebrationTrigger === "goalComplete" ? "goalComplete" : "perfectDay"
        }
      />
    </div>
  );
