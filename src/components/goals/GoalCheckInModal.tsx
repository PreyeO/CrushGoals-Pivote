...
import { CheckCircle2, TrendingUp, Clock, Ban, Sparkles, AlertTriangle } from "lucide-react";
import {
    Select,
    SelectContent,
    SelectItem,
...
export function GoalCheckInModal({ goal, children }: GoalCheckInModalProps) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            await upsertMemberStatus(goal.id, goal.orgId, memberStatus, note, progress);
