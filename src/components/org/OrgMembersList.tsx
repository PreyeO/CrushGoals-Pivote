...
import { Search, ChevronRight, Target, Flame, Crown, ShieldCheck, Shield } from "lucide-react";
...
export function OrgMembersList({ filteredMembers, goals, orgId }: OrgMembersListProps) {
