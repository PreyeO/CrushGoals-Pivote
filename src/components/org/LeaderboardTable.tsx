        ...
        <div className="space-y-6">
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-accent/30 border-b border-border/40">
                                <th className="px-6 py-4 text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground">Rank</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground">Member</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground">Goals Done</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground w-1/3">Avg. Completion</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground text-right">Accountability</th>
                            </tr>
                        </thead>
                                ...
                                <tr key={entry.memberId} className="hover:bg-primary/[0.02] transition-colors group cursor-pointer">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-bold group-hover:text-primary transition-colors">{entry.name}</p>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <span className="text-sm font-black text-foreground">{entry.goalsCompleted}</span>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="space-y-1.5">
                                            <div className="flex items-center justify-between text-[11px] font-bold">
                                                <span className="text-muted-foreground">{entry.completionRate}%</span>
                                            </div>
                                            <Progress value={entry.completionRate} className="h-2 rounded-full" />
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 text-right">
                                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[oklch(0.70_0.18_155_/_0.1)] text-[oklch(0.70_0.18_155)] border border-[oklch(0.70_0.18_155_/_0.2)]">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-wider">{entry.currentStreak} Streak</span>
                                        </div>
                                    </td>
                                </tr>
                            ))}
            ...
            {isLonely && (
                <div className="p-8 rounded-3xl bg-primary/5 border border-dashed border-primary/30 flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <h3 className="text-lg font-bold mb-2">It's lonely at the top (and everywhere else).</h3>
                    <p className="text-sm text-muted-foreground max-w-sm mb-6 leading-relaxed">
                        CrushGoals is better with teammates. Invite them to start competing for the #1 spot!
                    </p>
