    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 text-muted-foreground">
        ...
        <Link
          ...
          className="mt-6 text-xs font-black uppercase tracking-widest text-amber-500 hover:underline"
        >
          Clear filters
        </Link>
      </div>
              ...
              <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-foreground group-hover:text-amber-500 transition-colors line-clamp-1">
                      {org.name}
                    </span>
                    <span className="text-[10px] text-muted-foreground font-medium uppercase tracking-tight truncate max-w-37.5">
              ...
              <td className="px-6 py-4">
                {org.owner ? (
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold text-xs truncate max-w-30">
                        {org.owner.full_name}
                      </span>
                      <span className="text-[10px] text-muted-foreground truncate max-w-35 leading-none mb-0.5">
                        {org.owner.email}
                      </span>
                    </div>
                  </div>
                ...
                <Badge
                  ...
                  className={
                    org.plan === "pro"
                      ...
                      : "bg-accent/30 text-muted-foreground border-transparent uppercase text-[9px] font-bold"
                  }
                >
                  {org.plan}
                </Badge>
