...
import { Mail, Building2, Target, ShieldCheck, Users as UsersIcon } from "lucide-react";
                        ...
                        <tr key={user.id} className="group hover:bg-accent/5 transition-colors duration-200">
                            <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <Badge variant="outline" className="w-fit text-[8px] h-4 bg-accent/30 text-muted-foreground border-transparent uppercase font-bold">
                            ...
                            <td className="px-6 py-4 text-right">
                                {user.email === 'ayibakep@gmail.com' ? (
                                    ...
                                    <Badge variant="outline" className="bg-accent/50 text-muted-foreground border-transparent text-[9px] font-bold uppercase">
                                        User
                                    </Badge>
                                )}
                            </td>
