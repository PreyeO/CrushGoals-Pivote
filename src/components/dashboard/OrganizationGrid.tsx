  ...
  return (
    <div className="mt-8">
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-0">
          Your Organization
        </h2>
        {hasMore && (
          <button
        ...
        {showCreateCard && (
          <CreateOrgModal>
            <div className="glass-card border-dashed border-2! border-border/40! p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary/30! transition-all animate-fade-in-up group h-full">
              <div className="w-14 h-14 rounded-2xl bg-primary/8 flex items-center justify-center mb-4 group-hover:bg-primary/15  group-hover:scale-105 transition-transform">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Set up a new space and start tracking goals with your
                organization.
              </p>
            </div>
          </CreateOrgModal>
