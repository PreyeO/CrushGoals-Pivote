                    ...
                    <div className="py-6 space-y-4 animate-in fade-in zoom-in-95 duration-300">
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <div className="flex-1 bg-accent/30 border border-border/40 rounded-xl px-3 py-2 text-[13px] truncate font-mono text-muted-foreground flex items-center gap-2">
