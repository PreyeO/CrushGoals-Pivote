...
const tourSteps: TourStep[] = [
  {
    ...
    description: "Let's take a quick tour to show you how to become a goal-crushing champion. This will only take a minute!",
    target: "",
    position: "center",
    route: "/dashboard",
    icon: Rocket,
  },
  {
    ...
    description: "This is your dashboard — see today's tasks, your streak, active goals, and weekly progress all in one place. Click 'New Goal' anytime to get started!",
  ...
  },
  {
    ...
    description: "This is where all your goals live. Create goals, track progress, see streaks, and celebrate wins!",
  ...
  },
  {
    id: "tasks-page",
    title: "Daily Tasks",
    description: "Your daily missions will appear here once you create goals. Complete them to earn XP and build your streak!",
  ...
  },
  {
    ...
    description: "See how you rank against other goal crushers. You can invite friends to compete together!",
