                ...
                <Card className="glass-card border-border/40">
                    ...
                    <CardContent className="space-y-6">
                        <div className="space-y-3">
                            ...
                            <Progress value={goals.length > 0 ? (completedGoals / goals.length) * 100 : 0} className="h-1.5 bg-accent/20" />
                        </div>
                        <div className="space-y-3">
                            <div className="flex justify-between text-[11px] font-medium">
                            ...
                            <Progress value={goals.length > 0 ? ((goals.length - completedGoals - blockedGoals) / goals.length) * 100 : 0} className="h-1.5 bg-accent/20" />
                        </div>
                        <div className="space-y-3">
                            <div className="flex justify-between text-[11px] font-medium">
                            ...
                            <Progress value={goals.length > 0 ? (blockedGoals / goals.length) * 100 : 0} className="h-1.5 bg-accent/20" />
                        </div>
